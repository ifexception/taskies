...
std::vector<TasksViewColumn> DefaultTasksViewColumnList()
{
    ...
    return std::vector<TasksViewColumn>{
        { "Date", orderIndex++, TasksViewColumnTextAlignment::Center, TasksViewColumns::Date, 80 },
        { "Project",
            orderIndex++,
            TasksViewColumnTextAlignment::Left,
            TasksViewColumns::Project,
            80 },
        { "Category",
            orderIndex++,
            TasksViewColumnTextAlignment::Left,
            TasksViewColumns::Category,
            80 },
        { "Duration",
            orderIndex++,
            TasksViewColumnTextAlignment::Center,
            TasksViewColumns::Duration,
            80 },
        { "Description",
            orderIndex++,
            TasksViewColumnTextAlignment::Left,
            TasksViewColumns::Description,
            -1 }
    };
}
...
std::vector<TasksViewColumn> AvailableTasksViewColumnList()
{
    ...
    return std::vector<TasksViewColumn>{
        ...
        { "Employer",
            orderIndex,
            TasksViewColumnTextAlignment::Left,
            TasksViewColumns::Employer,
            80 },
        { "Client", orderIndex, TasksViewColumnTextAlignment::Left, TasksViewColumns::Client, 80 },
        { "Project",
            orderIndex,
            TasksViewColumnTextAlignment::Left,
            TasksViewColumns::Project,
        ...
        { "Billable",
            orderIndex,
            TasksViewColumnTextAlignment::Center,
            TasksViewColumns::Billable,
            80 },
        { "UniqueIdentifier",
            orderIndex,
            TasksViewColumnTextAlignment::Center,
            TasksViewColumns::UniqueIdentifier,
            80 },
        { "Description",
            orderIndex,
            TasksViewColumnTextAlignment::Left,
